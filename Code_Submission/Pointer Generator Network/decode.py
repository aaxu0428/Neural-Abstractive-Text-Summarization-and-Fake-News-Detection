...
from temp_decode import temp_decode
...
class BeamSearch(object):
    ...
    def decode(self):
        ...
        while batch is not None:
            ...
            original_article = batch.example_list[0].original_article
            write_for_rouge(original_article, decoded_words, counter,
        ...
        temp_decode(self._rouge_ref_dir, self._rouge_dec_dir)
